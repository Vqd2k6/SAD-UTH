...
3.  **Quản lý Khách hàng & Xác thực:** Đăng ký, đăng nhập. Hệ thống yêu cầu tải lên hình ảnh GPLX (hạng A1/A2...) nếu muốn đặt xe từ 50cc trở lên (chỉ nhằm mục đích lưu trữ bằng chứng xác minh và tăng độ tin cậy, không yêu cầu phê duyệt thủ công). Phân quyền tự động dựa trên việc khách hàng đã tải ảnh GPLX hay chưa.
...
*   **Đăng ký & Đăng nhập:** 
    ...
    *   Khách hàng chỉ cần tải ảnh chụp GPLX lên hệ thống là đủ điều kiện để đặt các dòng xe từ 50cc trở lên (không cần Admin/Nhân viên phê duyệt thủ công).
    *   Nếu không tải ảnh GPLX, tài khoản chỉ được phép đặt các dòng xe dưới 50cc và xe điện. Việc tải ảnh chỉ nhằm mục đích lưu trữ bằng chứng xác minh và tăng độ tin cậy.
*   **Tìm kiếm & Lọc xe máy:**
    ...
    *   Hiển thị rõ ràng ba phân loại nhóm xe và điều kiện tương ứng:
        *   *Nhóm xe dưới 50cc (và xe điện):* Dành cho học sinh, sinh viên hoặc khách hàng chưa tải ảnh GPLX.
        *   *Nhóm xe từ 50cc đến dưới 175cc:* Yêu cầu khách hàng bắt buộc phải tải lên ảnh GPLX hạng A1 hoặc A2 còn hiệu lực (hệ thống tự động ghi nhận, không cần duyệt).
        *   *Nhóm xe từ 175cc trở lên (Xe PKL):* Yêu cầu khách hàng bắt buộc phải tải lên ảnh GPLX hạng A2 còn hiệu lực (hệ thống tự động ghi nhận, không cần duyệt).
...
*   **Quản lý Đơn đặt xe (Booking Workflow):**
    *   Theo dõi danh sách các đơn đặt xe đã được hệ thống tự động xác nhận (sau khi khách cọc thành công) để chuẩn bị xe trước khi bàn giao. Nhân viên không tham gia vào bước phê duyệt đơn hàng hay xác thực ảnh GPLX trên hệ thống.
...
*   **Quy trình Nhận lại xe (Check-out):** 
    ...
    *   Kiểm tra tình trạng xe khi khách trả: Nhân viên ghi chép và nhập tay trực tiếp mức xăng và số ODO thực tế lúc trả xe vào ứng dụng, kiểm tra vết trầy xước/hư hỏng mới (so với ảnh chụp lúc giao).
